...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "testFood@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "testFood API";

        private String description = "testFood API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "testFood";
